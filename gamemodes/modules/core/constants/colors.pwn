/*
    File: modules/core/constants/colors.pwn
    Purpose: Contains core constants definitions and helpers for colors.
...
#define COLOR_SERVER      (0xE1997FCC)
#define COLOR_DEPARTMENT  (0xF0CC00FF)
#define COLOR_ADMINCHAT   (0x33EE33FF)
#define DEFAULT_COLOR     (0xFFFFFFFF)

#define X11_LIGHT_SKY_BLUE_1 (0xB0E2FFFF)
#define X11_GREY_80          (0xCCCCCCFF)
#define X11_TOMATO           (0xFF6347FF)
